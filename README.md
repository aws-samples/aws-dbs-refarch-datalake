...
AWS Glue Catalog is a metadata store to enable datalake schema evolution. Commonly, our customers use Glue crawler to crawl through the dataset in S3 and populate the catalog. Multiple AWS services can run query against the datalake through Glue catalog.
