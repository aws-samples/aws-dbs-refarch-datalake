# Merge Relational Database Changes Using AWS Glue

#### Scenario

Change data capture\(CDC\) is a very old technique to capture all mutations from a RDBMS. All changes that are captured from a relational databases get vca
